...
import AdminMechanisms from '../pages/AdminMechanisms.js'
...
import AdminGlasss from '../pages/AdminGlasss.js'
...
const adminRoutes = [
    ...
    {path: '/admin/mechanisms', Component: AdminMechanisms},
    ...
    {path: '/admin/glasss', Component: AdminGlasss},
